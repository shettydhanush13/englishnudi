...
const FAQ = () => {
    ...
    return (
        <LayoutWrapper>
            ...
            <button class="accordion" onClick={handleAccodian}>What does the English Nudi course offer?</button>
            <div class="panel">
            ...
            <button class="accordion" onClick={handleAccodian}>What happens in a live class?</button>
            <div class="panel">
